...
| R7 Hardening and legacy retirement | Active | #152, `r7-hardening-retirement-plan.md`, `r7-resource-envelope.md`, `r7-final-browser-proof.md`, `r7-legacy-write-freeze.md`, `r7-product-launcher.md`, `scripts/harness/check.sh r7-retirement-plan`, `scripts/harness/check.sh r7-resource-envelope`, `scripts/harness/check.sh r7-browser-proof`, `scripts/harness/check.sh r7-legacy-write-freeze`, `scripts/harness/check.sh r7-product-launcher`, and runtime cancellation contract coverage define scope, browser/resource/freeze/launcher guardrails, validation, rollback, and phase order | Broader recovery/concurrency hardening and surface-by-surface retirement |
