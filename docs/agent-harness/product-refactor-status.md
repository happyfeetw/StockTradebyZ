...
runtime hardening, final browser proof, and legacy retirement sequence.
...
| R7 Hardening and legacy retirement | Active | #152, `r7-hardening-retirement-plan.md`, `r7-resource-envelope.md`, `r7-final-browser-proof.md`, `r7-legacy-write-freeze.md`, `r7-product-launcher.md`, `r7-runtime-terminal-integrity.md`, `scripts/harness/check.sh r7-retirement-plan`, `scripts/harness/check.sh r7-resource-envelope`, `scripts/harness/check.sh r7-browser-proof`, `scripts/harness/check.sh r7-legacy-write-freeze`, `scripts/harness/check.sh r7-product-launcher`, `scripts/harness/check.sh r7-runtime-terminal-integrity`, and runtime cancellation contract coverage define scope, browser/resource/freeze/launcher guardrails, validation, rollback, and phase order | Broader recovery/concurrency hardening and surface-by-surface retirement |
...
- R7 still needs explicit hardening and retirement work before legacy
  ...
  disabled or removed.
- Runtime cancellation no longer overwrites terminal runs, and terminal run/step
  state is guarded at repository level. Broader concurrency and recovery
  hardening still needs R7 coverage.
