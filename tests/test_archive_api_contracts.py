    ...
    with session_factory() as session:
        ...
        session.add_all(
            [
                ...
                Artifact(
                    id="artifact-chart-history-000001-brick",
                    run=chart_export_run,
                    kind="chart",
                    path="run-chart-history/charts/batch-history/000001_brick_day.jpg",
                    content_type="image/jpeg",
                    metadata_json={
                        "source": "product:chart_export",
                        "artifact_scope": "strategy",
    ...
    async def test_archive_run_api_uses_selected_candidate_and_review_batches(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
                ...
                self.assertEqual(
                    ...
                    [
                        (
                            ...
                            "recommended",
                            1,
                            "artifact-chart-history-000001-b2",
                            "run-chart-history/charts/batch-history/000001_b2_day.jpg",
                        ),
                        (
                            "000001_brick",
                            "unreviewed",
                            None,
                            "artifact-chart-history-000001-brick",
                            "run-chart-history/charts/batch-history/000001_brick_day.jpg",
                        ),
                        (
                            "000002_brick",
                            "reviewed",
            ...
            self.assertEqual(
                chart_rows,
                [
                    ("000001", "b2", "artifact-chart-history-000001-b2"),
                    ("000001", "brick", "artifact-chart-history-000001-brick"),
